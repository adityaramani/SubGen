...
class AudioGenerator():
    ...
    def load_train_data(self, desc_file='/home/aditya/Documents/project/SubGen/res/speech-recognition-neural-network-master/train_corpus.json'):
        self.load_metadata_from_desc_file(desc_file, 'train')
        self.fit_train()
        if self.sort_by_duration:
            self.sort_data_by_duration('train')

    def load_validation_data(self, desc_file='/home/aditya/Documents/project/SubGen/res/speech-recognition-neural-network-master/valid_corpus.json'):
        self.load_metadata_from_desc_file(desc_file, 'validation')
        if self.sort_by_duration:
            self.sort_data_by_duration('valid')

    def load_test_data(self, desc_file='/home/aditya/Documents/project/SubGen/res/speech-recognition-neural-network-master/test_corpus.json'):
